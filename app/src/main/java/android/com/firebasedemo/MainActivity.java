...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //control
        circular_progress = (ProgressBar) findViewById(R.id.progressBar);
        input_name = (EditText) findViewById(R.id.editTextName);
        input_email = (EditText) findViewById(R.id.editTextEmail);
        list_data = (ListView) findViewById(R.id.listData);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.menu_add) {
            ...
            User user = new User(selectUser.getUid(), input_name.getText().toString(), input_email.getText().toString());
            updateUser(user);
    ...
    private void deleteUser(User selectUser) {
        mDatabaseReference.child("users").child(selectUser.getUid()).removeValue();
        clearEditText();
    }
    ...
    private void createUser() {
        ...
        mDatabaseReference.child("üsers").child(user.getUid()).setValue(user);
        clearEditText();
    }
